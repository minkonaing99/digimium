...
<body>
    ...
    <div class="container-fluid">
        <section class="menu-bar p-md-5 py-md-3  pb-md-2 p-1">
        ...
        <section>
            <div class="row">
                <div class="col-4">
                    ...
                    <div class="d-flex justify-content-center align-items-center chart-row" id="report">
                        This is the report
                    </div>
                </div>
                <div class="col-8">
                    <div class="row mt-md-2 p-2">
                        ...
                        <div class="row justify-content-center">
                            <div class="alert alert-success alert-dismissible fade show row justify-content-center mt-2" role="alert">
