...
<head>
    ...
    <?php foreach (\Digimium\Core\Assets::tagsFor('summary.css') as $href): ?>
...
<body>
        ...
        <section class="era-table-card mb " aria-labelledby="tbl-title">
            ...
            <div class="kpi-grid">
                <article class="kpi-card" data-kpi="period_sales">
                    ...
                    <svg class="kpi-spark" viewBox="0 0 100 28" preserveAspectRatio="none" aria-hidden="true"></svg>
                </article>
    ...
    <?php $chartFs = @filemtime(__DIR__ . '/vendor/chart.umd.min.js'); ?>
    <script src="./vendor/chart.umd.min.js<?= $chartFs !== false ? '?v=' . $chartFs : '' ?>"></script>
    <?php foreach (\Digimium\Core\Assets::tagsFor('summary.js') as $src): ?>
