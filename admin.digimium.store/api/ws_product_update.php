...
try {
    ...
    $errors = [];
    if (!$id || !is_int($id) || $id < 1)                             $errors['id']           = 'Valid product ID is required.';
    ...
    try {
        \Digimium\Core\ProductRepository::wholesale(\Digimium\Core\Database::connection())->updateFull($id, [
    ...
    error_log('ws_product_update.php error: ' . $e->getMessage());
