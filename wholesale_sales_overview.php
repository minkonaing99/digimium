            ...
            <div class="row d-flex justify-content-between align-items-center">
                ...
                <div class="col d-flex justify-content-end">
                    <div class="btn-group">
                        ...
                        <button class="contact-btn mobile-btn order-3" id="addBtn"><span class="d-none d-md-inline">Add Sales</span><img src="./assets/add-icon.svg" alt="" width="24px" style="border: none;" class="m-2 m-md-0 d-md-none"></button>
                    </div>
                </div>
